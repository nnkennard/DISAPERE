        ...
        with open(filename, 'r') as f:
            ...
            for sentence in example["review_sentences"]:
                for label in REVIEW_LABELS:
                    rows.append(Row(subset, label, "_", sentence["text"], sentence["text"], sentence[label]))
            for sentence in example["rebuttal_sentences"]:
                for label in REBUTTAL_LABELS:
                    rows.append(Row(subset, "reb_"+label, "_", sentence["text"], sentence["text"], sentence[label]))
...
with open("all_DISAPERE.tsv", 'w') as f:
